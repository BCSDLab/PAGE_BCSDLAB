export const trackDatas = [
  ...
  },
  {
    ...
    'about': [
      {
        'title': '기초 위주의 수업',
        'description': '비기너 과정에 맞게 커리큘럼 구성'
      },
      {
        'title': '디자인 패턴 기반의 프로젝트',
        'description': '실무에서의 프로젝트 구조 이해'
      },
      {
        'title': '프로젝트 기반의 커리큘럼',
        'description': '프로젝트 제작 과정 이해'
      }
    ],
    'curriculums': [
      {
      ...
      },
      {
        ...
        'contents': [
          {
            'title': '[프로젝트2] 주변 식당 소개 앱 만들기 - 디자인 패턴',
            'descriptions': [
              '디자인 패턴에 대해',
              'MVC, MVVM패턴의 특징과 차이점',
              'SwiftUI에서의 MVVM 패턴 구조'
            ]
          }
        ]
      },
      {
        ...
        'contents': [
          {
            'title': '[프로젝트2] 주변 식당 소개 앱 만들기 - 라이브러리 활용',
            'descriptions': [
              'Cocoapod에 대해',
              'Alamofire에 대해',
              'API 연결'
  ...
  },
  {
    ...
    'about': [
      {
        'title': '상용화 프로젝트 경험',
        'description': '실제 웹/앱 디자인 후 상용화하는<br>프로세스 경험을 통해 실무 능력 배양'
      },
      {
        'title': 'UI/UX 커리어 설계',
        'description': 'UI/UX 디자이너로 성장하기 위한<br>선배들의 커리어 피드백'
      },
      {
        'title': '실무 노하우 학습',
        'description': '학교에서 배우지 않는 실무 노하우로<br>전문 인재 육성'
      }
    ],
    'curriculums': [
      {
  ...
  },
  {
    ...
    'about': [
      {
        'title': '다각적 학습 기회',
        'description': '게임 프로그래밍을 배울 수 있는 기회'
      },
      {
        'title': '재미를 만듭니다',
        'description': '원하는 게임을 직접 만들 수 있도록 지원'
      },
      {
        'title': '함께 만드는 게임',
        'description': '상호발전과 유대감 형성'
      }
    ],
    'curriculums': [
      {
